...
export default function Home() {
  return (
    <div className="min-h-screen h-full w-full flex flex-col bg-brand-light overflow-hidden">
      ...
      <header className="min-w-full text-white-800 py-14 px-4 md:px-0">
        <div className="flex items-center container mx-auto max-w-5xl justify-between h-full">
          ...
          <Link href="#">
            <a className="font-coiny text-xl md:text-3xl font-bold">
              <span className="bg-gradient-to-br from-brand-white to-brand-white pr-2 bg-clip-text ">
                Ghost
              </span>
              OG
            </a>
          ...
          {/*  Twitter and Discord Links */}
          <nav aria-label="Contact Menu">
            <ul className="flex items-center space-x-4 md:space-x-6">
              
              <li className="cursor-pointer">
                <a
                  href="https://twitter.com/GhostEliteNFTs"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
              ...
              <li className="cursor-pointer">
                <a
                  href="https://discord.gg/YwPmzDCJTV"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
      ...
      <div className="h-full w-full container max-w-5xl mx-auto flex flex-col items-center pt-4">
        <div className="flex flex-col items-center max-w-4xl w-full">
          ...
          <div className="flex flex-col md:flex-row md:space-x-16 space-y-10 items-center mt-20 w-full">
            ...
            <div className="flex flex-col md:items-start items-center justify-center text-center font-coiny text-white-800 px-4 md:px-0 py-10 mt-14">
              <h2 className="font-bold text-2xl md:text-4xl uppercase">
                About Ghost OG
              </h2>

              <p className="mt-6 text-lg">
                Ghost is a Community Driven Project aimed at bringing gamification and P2E to Cronos.
                The NFT collection consists of 7070 interactive NFTs, with various benefits. Join Ghostly World now to become a part of this journey.
                <br/>
                <br/>
                Every 1000 mints the price will increase!
              </p>
            </div>
          </div>
        </div>
